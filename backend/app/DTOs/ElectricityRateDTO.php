...
final readonly class ElectricityRateDTO
{
    public function __construct(
        ...
        public int $marketPrice, // in micro-units (e.g., 202500 = €0.2025)
        public int $totalPriceTaxIncluded,
        public int $priceInclHandlingVat,
        public int $priceTaxWithVat,
        public ?string $pricingProfile = null,
        public ?int $carbonFootprintInGram = null,
        public ?int $sustainabilityScore = null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'pricing_profile' => $this->pricingProfile,
            'carbon_footprint_in_gram' => $this->carbonFootprintInGram,
    ...
    {
        return $this->marketPrice / 1000000; // Convert micro-euros to euros
    }
